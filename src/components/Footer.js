                            ...
                            <div className="row">
                                <div className="col-xl-5 col-lg-4 col-md-12 col-sm-12">
                                    <div className="widget">
                                        <img src="images/logo-white.png" width="180" className="m-b15" alt="" />
                                        ...
                                        <div className="subscribe-form m-b20">
                                            <form className="dzSubscribe" action="http://job-board.dexignzone.com/xhtml/script/mailchamp.php" method="post">
